...
| ライブラリ | 用途 | ライセンス | 条文 |
|------------|------|------------|------|
| `react` / `react-dom` | 拡張の UI 描画 | MIT | [LICENSE](https://github.com/react/react/blob/v19.2.5/LICENSE) |
| `marked` | Markdown 解析 | MIT | [LICENSE](https://github.com/markedjs/marked/blob/v18.0.5/LICENSE) |
...
| `vitest` / `playwright` | テスト | MIT | [vitest](https://github.com/vitest-dev/vitest/blob/main/LICENSE) / [playwright](https://github.com/microsoft/playwright/blob/main/LICENSE) |
...
| `useHomeStorageBootstrap.ts` | ホーム初回マウントで KogiNews の先読みと `storage` からのショートカット・課題・コース読み込み |
