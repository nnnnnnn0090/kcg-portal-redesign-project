...
indigo: {
  ...
  accent: '#818cf8', onAccent: '#000000', accentLight: '#a5b4fc', accentBg: 'rgba(129,140,248,.15)',
...
stone: {
  ...
  accent: '#f59e0b', onAccent: '#000000', accentLight: '#fbbf24', accentBg: 'rgba(245,158,11,.12)',
...
espresso: {
  ...
  accent: '#d97706', onAccent: '#000000', accentLight: '#fbbf24', accentBg: 'rgba(217,119,6,.15)',
...
aurora: {
  ...
  accent: '#f472b6', onAccent: '#000000', accentLight: '#f9a8d4', accentBg: 'rgba(244,114,182,.12)',
...
twilight: {
  ...
  accent: '#e879f9', onAccent: '#000000', accentLight: '#f0abfc', accentBg: 'rgba(232,121,249,.12)',
...
rosewood: {
  ...
  accent: '#fb7185', onAccent: '#000000', accentLight: '#fda4af', accentBg: 'rgba(251,113,133,.15)',
...
lavender: {
  ...
  accent: '#9333ea', onAccent: '#ffffff', accentLight: '#a855f7', accentBg: 'rgba(147,51,234,.08)',
...
mint: {
  ...
  accent: '#16a34a', onAccent: '#000000', accentLight: '#22c55e', accentBg: 'rgba(22,163,74,.1)',
...
paper: {
  ...
  accent: '#b45309', onAccent: '#ffffff', accentLight: '#d97706', accentBg: 'rgba(180,83,9,.1)',
...
sage: {
  ...
  accent: '#6b8f71', onAccent: '#000000', accentLight: '#84a989', accentBg: 'rgba(107,143,113,.12)',
...
coral: {
  ...
  accent: '#ea580c', onAccent: '#000000', accentLight: '#f97316', accentBg: 'rgba(234,88,12,.1)',
...
cream: {
  ...
  accent: '#ca8a04', onAccent: '#000000', accentLight: '#eab308', accentBg: 'rgba(202,138,4,.1)',
...
peach: {
  ...
  accent: '#e11d48', onAccent: '#ffffff', accentLight: '#f43f5e', accentBg: 'rgba(225,29,72,.08)',
...
storm: {
  ...
  accent: '#3b82f6', onAccent: '#000000', accentLight: '#60a5fa', accentBg: 'rgba(59,130,246,.08)',
...
sand: {
  ...
  accent: '#d97706', onAccent: '#000000', accentLight: '#f59e0b', accentBg: 'rgba(217,119,6,.1)',
...
void: {
  ...
  accent: '#a78bfa', onAccent: '#000000', accentLight: '#c4b5fd', accentBg: 'rgba(167,139,250,.12)',
...
obsidian: {
  ...
  accent: '#58a6ff', onAccent: '#000000', accentLight: '#79c0ff', accentBg: 'rgba(88,166,255,.12)',
...
nocturne: {
  ...
  accent: '#c084fc', onAccent: '#000000', accentLight: '#e879f9', accentBg: 'rgba(192,132,252,.12)',
...
tokyoNight: {
  ...
  accent: '#7aa2f7', onAccent: '#000000', accentLight: '#89ddff', accentBg: 'rgba(122,162,247,.12)',
...
mochaDark: {
  ...
  accent: '#d6ac84', onAccent: '#000000', accentLight: '#e8c4a8', accentBg: 'rgba(214,172,132,.12)',
...
copper: {
  ...
  accent: '#ea8c55', onAccent: '#000000', accentLight: '#f4a460', accentBg: 'rgba(234,140,85,.12)',
...
oliveNight: {
  ...
  accent: '#bef264', onAccent: '#000000', accentLight: '#d9f99d', accentBg: 'rgba(190,242,100,.12)',
...
bloodMoon: {
  ...
  accent: '#f87171', onAccent: '#000000', accentLight: '#fca5a5', accentBg: 'rgba(248,113,113,.12)',
...
sapphire: {
  ...
  accent: '#3b82f6', onAccent: '#000000', accentLight: '#60a5fa', accentBg: 'rgba(59,130,246,.15)',
...
onyx: {
  ...
  accent: '#eab308', onAccent: '#000000', accentLight: '#facc15', accentBg: 'rgba(234,179,8,.12)',
...
raven: {
  ...
  accent: '#94a3b8', onAccent: '#000000', accentLight: '#cbd5e1', accentBg: 'rgba(148,163,184,.12)',
...
abyssal: {
  ...
  accent: '#0ea5e9', onAccent: '#000000', accentLight: '#38bdf8', accentBg: 'rgba(14,165,233,.12)',
...
terminal: {
  ...
  accent: '#facc15', onAccent: '#000000', accentLight: '#fde047', accentBg: 'rgba(250,204,21,.1)',
...
slateNight: {
  ...
  accent: '#38bdf8', onAccent: '#000000', accentLight: '#7dd3fc', accentBg: 'rgba(56,189,248,.1)',
...
emberDark: {
  ...
  accent: '#fb923c', onAccent: '#000000', accentLight: '#fdba74', accentBg: 'rgba(251,146,60,.12)',
...
ice: {
  ...
  accent: '#0284c7', onAccent: '#000000', accentLight: '#0ea5e9', accentBg: 'rgba(2,132,199,.08)',
...
spring: {
  ...
  accent: '#65a30d', onAccent: '#000000', accentLight: '#84cc16', accentBg: 'rgba(101,163,13,.1)',
...
autumn: {
  ...
  textDim: '#c2410c', textDimmer: '#ea580c', textBright: '#431407',
  accent: '#c2410c', onAccent: '#ffffff', accentLight: '#ea580c', accentBg: 'rgba(194,65,12,.1)',
...
periwinkle: {
  ...
  accent: '#4f46e5', onAccent: '#ffffff', accentLight: '#6366f1', accentBg: 'rgba(79,70,229,.08)',
...
lilacMist: {
  ...
  accent: '#a855f7', onAccent: '#000000', accentLight: '#c084fc', accentBg: 'rgba(168,85,247,.08)',
...
roseGold: {
  ...
  accent: '#e11d48', onAccent: '#ffffff', accentLight: '#f43f5e', accentBg: 'rgba(225,29,72,.07)',
...
porcelain: {
  ...
  accent: '#57534e', onAccent: '#ffffff', accentLight: '#78716c', accentBg: 'rgba(87,83,78,.08)',
...
mist: {
  ...
  accent: '#71717a', onAccent: '#ffffff', accentLight: '#a1a1aa', accentBg: 'rgba(113,113,122,.1)',
...
sepia: {
  ...
  textDim: '#78716c', textDimmer: '#a8a29e', textBright: '#1c1917',
  accent: '#92400e', onAccent: '#ffffff', accentLight: '#b45309', accentBg: 'rgba(146,64,14,.1)',
...
newspaper: {
  ...
  accent: '#1c1917', onAccent: '#ffffff', accentLight: '#44403c', accentBg: 'rgba(28,25,23,.06)',
...
emeraldLight: {
  ...
  accent: '#059669', onAccent: '#000000', accentLight: '#10b981', accentBg: 'rgba(5,150,105,.08)',
...
cherryBlossom: {
  ...
  textDim: '#be185d', textDimmer: '#db2777', textBright: '#500724',
  accent: '#ec4899', onAccent: '#000000', accentLight: '#f472b6', accentBg: 'rgba(236,72,153,.08)',
...
arctic: {
  ...
  accent: '#0ea5e9', onAccent: '#000000', accentLight: '#38bdf8', accentBg: 'rgba(14,165,233,.08)',
...
powder: {
  ...
  textDim: '#0369a1', textDimmer: '#0284c7', textBright: '#082f49',
  accent: '#0ea5e9', onAccent: '#000000', accentLight: '#38bdf8', accentBg: 'rgba(14,165,233,.07)',
...
vanilla: {
  ...
  textDim: '#78716c', textDimmer: '#a8a29e', textBright: '#1c1917',
  accent: '#ca8a04', onAccent: '#000000', accentLight: '#eab308', accentBg: 'rgba(202,138,4,.09)',
...
denim: {
  ...
  textDim: '#475569', textDimmer: '#64748b', textBright: '#0f172a',
  accent: '#334155', onAccent: '#ffffff', accentLight: '#475569', accentBg: 'rgba(51,65,85,.1)',
...
blush: {
  ...
  textDim: '#7c3aed', textDimmer: '#8b5cf6', textBright: '#3b0764',
  accent: '#8b5cf6', onAccent: '#000000', accentLight: '#a78bfa', accentBg: 'rgba(139,92,246,.07)',
...
seafoam: {
  ...
  accent: '#0d9488', onAccent: '#000000', accentLight: '#14b8a6', accentBg: 'rgba(13,148,136,.08)',
...
buttercream: {
  ...
  accent: '#d97706', onAccent: '#000000', accentLight: '#f59e0b', accentBg: 'rgba(217,119,6,.09)',
...
graphiteLight: {
  ...
  accent: '#64748b', onAccent: '#ffffff', accentLight: '#94a3b8', accentBg: 'rgba(100,116,139,.1)',
