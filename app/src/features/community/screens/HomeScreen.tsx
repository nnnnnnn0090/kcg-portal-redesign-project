        ...
        {loading ? (
          ...
          >
            ...
            {posts.length > 9 ? (
              <button
                className={
                  'community-more tw-mx-auto tw-mt-4 tw-flex tw-min-h-10 tw-items-center tw-rounded-lg tw-border-0 tw-bg-community-bg3 tw-px-4 tw-font-bold tw-text-community-accent-light tw-cursor-pointer'
                }
                onClick={onExplore}
              >
