...
export const THEMES: Record<string, ThemeTokens> = {
  dark: {
    ...
    accent: '#3b82f6', onAccent: '#000000', accentLight: '#60a5fa', accentBg: 'rgba(59,130,246,.12)',
  ...
  light: {
    ...
    accent: '#2563eb', onAccent: '#ffffff', accentLight: '#3b82f6', accentBg: 'rgba(37,99,235,.08)',
  ...
  pink: {
    ...
    accent: '#db2777', onAccent: '#ffffff', accentLight: '#ec4899', accentBg: 'rgba(219,39,119,.1)',
  ...
  cyan: {
    ...
    accent: '#0891b2', onAccent: '#000000', accentLight: '#06b6d4', accentBg: 'rgba(8,145,178,.1)',
  ...
  midnight: {
    ...
    accent: '#38bdf8', onAccent: '#000000', accentLight: '#7dd3fc', accentBg: 'rgba(56,189,248,.12)',
  ...
  nord: {
    ...
    accent: '#88c0d0', onAccent: '#000000', accentLight: '#8fbcbb', accentBg: 'rgba(136,192,208,.15)',
  ...
  forest: {
    ...
    accent: '#4ade80', onAccent: '#000000', accentLight: '#86efac', accentBg: 'rgba(74,222,128,.12)',
  ...
  ocean: {
    ...
    accent: '#22d3ee', onAccent: '#000000', accentLight: '#67e8f9', accentBg: 'rgba(34,211,238,.12)',
  ...
  grape: {
    ...
    accent: '#a78bfa', onAccent: '#000000', accentLight: '#c4b5fd', accentBg: 'rgba(167,139,250,.15)',
