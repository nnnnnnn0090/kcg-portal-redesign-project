...
import { CPLAN_RUNTIME_STYLE_KEY, PORTAL_DOM } from '../../contract/dom';
import { ZINDEX } from '../../contract/zindex';
...
const PORTAL_BACKDROP_Z = ZINDEX.portalBackdrop;
