  ...
  return (
    ...
    >
      <div
        ...
        aria-live="polite"
        className={cn(
          'community-notification-toast tw-pointer-events-auto tw-grid tw-grid-cols-[auto_minmax(0,1fr)_auto] tw-items-start tw-gap-3 tw-rounded-xl tw-border tw-border-community-border tw-bg-[color-mix(in_srgb,var(--p-bg2)_94%,transparent)] tw-p-3 tw-shadow-[0_12px_36px_color-mix(in_srgb,#000_28%,transparent)] tw-backdrop-blur-sm',
          closing
      ...
      >
        ...
        <button
          type="button"
          className="tw-inline-flex tw-h-7 tw-w-7 tw-flex-none tw-items-center tw-justify-center tw-rounded-full tw-border-0 tw-bg-community-bg3 tw-text-xs tw-font-bold tw-text-community-muted tw-cursor-pointer hover:tw-text-community-text"
